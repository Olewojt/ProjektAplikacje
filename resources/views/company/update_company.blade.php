        ...
        <form method="POST" action={{ route('company.store') }}>
            ...
            <div class='row'>
                <div class='col-md-6 px-4'>
                    ...
                    <input type='email' name='e_mail' class="form-control"  maxlength=100>
                </div>
                <div class='col-md-6 px-4'>
                    <label for='website' class='formLabels'>Strona www</label><br/>
                    <input type='text' name='website' class="form-control"  maxlength=200>
                </div>
            </div>
            <hr>
            <div class='row'>
                <div class='col-md-6 px-4'>
                    ...
                    <input type='text' name='building_number' class="form-control"  maxlength=10>
                    <label for='zip_code' class='formLabels'>Kod pocztowy</label><br/>
                    <input type='text' name='zip_code' class="form-control"  maxlength=6>
                </div>
                <div class='col-md-6 px-4'>
            ...
            <div class='row'>
                <div class='col-md-6 px-4'>
                    ...
                    <input type='text' name='nip' class="form-control"  maxlength=10>
                </div>

                <div class='col-md-6 px-4'>
                    <label for='regon' class='formLabels'>REGON</label><br/>
                    <input type='text' name='regon' class="form-control"  maxlength=14>
                </div>
            </div>
            ...
            <div class='row'>
                <div class='col-md-12 px-4'>
                    ...
                    <textarea class="form-control" name="description" rows="3" maxlength=1024></textarea>
                </div>
            </div>
